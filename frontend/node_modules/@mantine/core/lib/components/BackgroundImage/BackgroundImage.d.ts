import { BoxProps, MantineRadius, PolymorphicFactory, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const BackgroundImage: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, BackgroundImageProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(BackgroundImageProps & {
    component?: any;
