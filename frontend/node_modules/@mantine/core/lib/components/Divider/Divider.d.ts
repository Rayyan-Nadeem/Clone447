import { BoxProps, ElementProps, Factory, MantineColor, MantineSize, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const Divider: import("@mantine/core/lib/core").MantineComponent<{
    props: DividerProps;
    ref: HTMLDivElement;
    stylesNames: DividerStylesNames;
    vars: DividerCssVariables;
