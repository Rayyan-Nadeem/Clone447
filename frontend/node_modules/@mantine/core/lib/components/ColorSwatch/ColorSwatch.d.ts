...
export declare const ColorSwatch: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, ColorSwatchProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(ColorSwatchProps & {
    component?: any;
