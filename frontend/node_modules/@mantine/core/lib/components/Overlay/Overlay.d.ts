...
export declare const Overlay: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, OverlayProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(OverlayProps & {
    component?: any;
