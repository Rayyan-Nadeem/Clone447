...
import { __ColorPickerProps, ColorPickerStylesNames } from '@mantine/core/lib/components/ColorPicker';
import { __BaseInputProps, __InputStylesNames, InputVariant } from '@mantine/core/lib/components/Input';
import { PopoverProps } from '@mantine/core/lib/components/Popover';
...
export declare const ColorInput: import("@mantine/core/lib/core").MantineComponent<{
    props: ColorInputProps;
    ref: HTMLInputElement;
    stylesNames: ColorInputStylesNames;
    vars: ColorInputCssVariables;
