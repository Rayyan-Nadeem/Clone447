...
export declare const Center: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, CenterProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(CenterProps & {
    component?: any;
