import { BoxProps, ElementProps, Factory, MantineColor, MantineRadius, StylesApiProps } from '@mantine/core/lib/core';
import { TabsList, TabsListStylesNames } from '@mantine/core/lib/components/Tabs/TabsList/TabsList';
import { TabsPanel, TabsPanelStylesNames } from '@mantine/core/lib/components/Tabs/TabsPanel/TabsPanel';
import { TabsTab, TabsTabStylesNames } from '@mantine/core/lib/components/Tabs/TabsTab/TabsTab';
...
export declare const Tabs: import("@mantine/core/lib/core").MantineComponent<{
    props: TabsProps;
    ref: HTMLDivElement;
    variant: TabsVariant;
    stylesNames: TabsStylesNames;
