import { BoxProps, MantineColor, MantineGradient, MantineSize, PolymorphicFactory, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const Text: (<C = "p">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, TextProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(TextProps & {
    component?: any;
