import { BoxProps, ElementProps, Factory, StylesApiProps } from '@mantine/core/lib/core';
import { __CloseButtonProps } from '@mantine/core/lib/components/CloseButton';
import { ComboboxLikeProps, ComboboxLikeRenderOptionInput, ComboboxLikeStylesNames, ComboboxStringData, ComboboxStringItem } from '@mantine/core/lib/components/Combobox';
import { __BaseInputProps, __InputStylesNames } from '@mantine/core/lib/components/Input';
import { ScrollAreaProps } from '@mantine/core/lib/components/ScrollArea';
...
export declare const TagsInput: import("@mantine/core/lib/core").MantineComponent<{
    props: TagsInputProps;
    ref: HTMLInputElement;
    stylesNames: TagsInputStylesNames;
}>;
