import { BoxProps, StylesApiProps } from '@mantine/core/lib/core';
import { __BaseInputProps } from '@mantine/core/lib/components/Input/Input';
...
export declare function useInputProps<T extends BaseProps, U extends Partial<T>>(component: string, defaultProps: U, _props: T): Omit<T & { [Key in Extract<keyof T, never>]-?: {}[Key] | NonNullable<T[Key]>; }, "label" | "style" | "size" | "styles" | "className" | "id" | "vars" | "variant" | "unstyled" | "classNames" | "required" | "mod" | "error" | "description" | "__staticSelector" | "__stylesApiProps" | "withAsterisk" | "labelProps" | "descriptionProps" | "errorProps" | "inputContainer" | "inputWrapperOrder" | "wrapperProps"> & {
    classNames: Partial<Record<string, string>> | ((theme: import("@mantine/core/lib/core").MantineTheme, props: any, ctx: unknown) => Partial<Record<string, string>>) | undefined;
    styles: Partial<Record<string, import("@mantine/core/lib/core").CSSProperties>> | ((theme: import("@mantine/core/lib/core").MantineTheme, props: any, ctx: unknown) => Partial<Record<string, import("@mantine/core/lib/core").CSSProperties>>) | undefined;
    ...
    wrapperProps: {
        ...
        unstyled: boolean | undefined;
        styles: Partial<Record<string, import("@mantine/core/lib/core").CSSProperties>> | ((theme: import("@mantine/core/lib/core").MantineTheme, props: any, ctx: unknown) => Partial<Record<string, import("@mantine/core/lib/core").CSSProperties>>) | undefined;
        size: (string & {}) | import("@mantine/core/lib/core").MantineSize | undefined;
        style: import("@mantine/core/lib/core").MantineStyleProp;
        ...
        id: string | undefined;
        mod: import("@mantine/core/lib/core").BoxMod | undefined;
    } & BoxProps;
    inputProps: {
        required: boolean | undefined;
        classNames: Partial<Record<string, string>> | ((theme: import("@mantine/core/lib/core").MantineTheme, props: any, ctx: unknown) => Partial<Record<string, string>>) | undefined;
