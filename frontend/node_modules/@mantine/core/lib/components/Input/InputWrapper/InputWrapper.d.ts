import { BoxProps, ElementProps, Factory, MantineSize, StylesApiProps } from '@mantine/core/lib/core';
import { InputDescriptionCssVariables, InputDescriptionStylesNames } from '@mantine/core/lib/components/Input/InputDescription/InputDescription';
import { InputErrorCssVariables, InputErrorStylesNames } from '@mantine/core/lib/components/Input/InputError/InputError';
import { InputLabelCssVariables, InputLabelStylesNames } from '@mantine/core/lib/components/Input/InputLabel/InputLabel';
...
export declare const InputWrapper: import("@mantine/core/lib/core").MantineComponent<{
    props: InputWrapperProps;
    ref: HTMLDivElement;
    stylesNames: InputWrapperStylesNames;
    vars: InputWrapperCssVariables;
