import { BoxProps, MantineRadius, MantineSize, PolymorphicFactory, StylesApiProps } from '@mantine/core/lib/core';
import { InputDescription } from '@mantine/core/lib/components/Input/InputDescription/InputDescription';
import { InputError } from '@mantine/core/lib/components/Input/InputError/InputError';
import { InputLabel } from '@mantine/core/lib/components/Input/InputLabel/InputLabel';
import { InputPlaceholder } from '@mantine/core/lib/components/Input/InputPlaceholder/InputPlaceholder';
import { __InputWrapperProps, InputWrapper, InputWrapperStylesNames } from '@mantine/core/lib/components/Input/InputWrapper/InputWrapper';
...
export declare const Input: (<C = "input">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, InputProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(InputProps & {
    component?: any;
