import { BoxProps, ElementProps, Factory, MantineRadius, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const CheckboxCard: import("@mantine/core/lib/core").MantineComponent<{
    props: CheckboxCardProps;
    ref: HTMLButtonElement;
    stylesNames: CheckboxCardStylesNames;
    vars: CheckboxCardCssVariables;
