import { BoxProps, CompoundStylesApiProps, PolymorphicFactory } from '@mantine/core/lib/core';
...
export declare const AppShellSection: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, AppShellSectionProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(AppShellSectionProps & {
    component?: any;
