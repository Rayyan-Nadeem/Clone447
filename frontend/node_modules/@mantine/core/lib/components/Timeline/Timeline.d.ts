...
import { TimelineItem, TimelineItemStylesNames } from '@mantine/core/lib/components/Timeline/TimelineItem/TimelineItem';
...
export declare const Timeline: import("@mantine/core/lib/core").MantineComponent<{
    props: TimelineProps;
    ref: HTMLDivElement;
    stylesNames: TimelineStylesNames;
    vars: TimelineCssVariables;
