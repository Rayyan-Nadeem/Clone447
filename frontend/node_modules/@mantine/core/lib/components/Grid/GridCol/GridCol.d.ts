import { BoxProps, CompoundStylesApiProps, ElementProps, Factory, StyleProp } from '@mantine/core/lib/core';
...
export declare const GridCol: import("@mantine/core/lib/core").MantineComponent<{
    props: GridColProps;
    ref: HTMLDivElement;
    stylesNames: GridColStylesNames;
    compound: true;
