...
export declare const CloseButton: (<C = "button">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, CloseButtonProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(CloseButtonProps & {
    component?: any;
