...
import { ButtonGroup } from '@mantine/core/lib/components/Button/ButtonGroup/ButtonGroup';
...
export declare const Button: (<C = "button">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, ButtonProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(ButtonProps & {
    component?: any;
