import { BoxProps, CompoundStylesApiProps, MantineColor, PolymorphicFactory } from '@mantine/core/lib/core';
...
export declare const MenuItem: (<C = "button">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, MenuItemProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(MenuItemProps & {
    component?: any;
