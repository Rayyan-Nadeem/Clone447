...
export declare const Badge: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, BadgeProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(BadgeProps & {
    component?: any;
