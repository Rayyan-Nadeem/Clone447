import { BoxProps, ElementProps, MantineSize, PolymorphicFactory, StyleProp, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const Flex: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, FlexProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(FlexProps & {
    component?: any;
