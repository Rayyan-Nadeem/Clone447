...
export declare const Image: (<C = "img">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, ImageProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(ImageProps & {
    component?: any;
