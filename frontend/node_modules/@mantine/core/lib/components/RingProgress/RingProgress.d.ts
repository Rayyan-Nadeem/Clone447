import { BoxProps, ElementProps, Factory, MantineColor, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const RingProgress: import("@mantine/core/lib/core").MantineComponent<{
    props: RingProgressProps;
    ref: HTMLDivElement;
    stylesNames: RingProgressStylesNames;
    vars: RingProgressCssVariables;
