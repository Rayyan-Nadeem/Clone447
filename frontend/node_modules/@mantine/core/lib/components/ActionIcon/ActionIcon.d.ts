import { BoxProps, MantineColor, MantineGradient, MantineRadius, MantineSize, PolymorphicFactory, StylesApiProps } from '@mantine/core/lib/core';
import { LoaderProps } from '@mantine/core/lib/components/Loader';
import { ActionIconGroup } from '@mantine/core/lib/components/ActionIcon/ActionIconGroup/ActionIconGroup';
...
export declare const ActionIcon: (<C = "button">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, ActionIconProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(ActionIconProps & {
    component?: any;
