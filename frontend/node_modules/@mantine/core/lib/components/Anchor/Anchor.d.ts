import { PolymorphicFactory } from '@mantine/core/lib/core';
import { TextCssVariables, TextProps, TextStylesNames, TextVariant } from '@mantine/core/lib/components/Text';
...
export declare const Anchor: (<C = "a">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, AnchorProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(AnchorProps & {
    component?: any;
