import { BoxProps, CompoundStylesApiProps, ElementProps, Factory, FactoryPayload } from '@mantine/core/lib/core';
import type { TableFactory } from '@mantine/core/lib/components/Table/Table';
...
export declare function tableElement<Factory extends FactoryPayload>(element: 'th' | 'td' | 'tr' | 'thead' | 'tbody' | 'tfoot' | 'caption', options?: TableElementOptions): import("@mantine/core/lib/core").MantineComponent<Factory>;
export declare const TableTh: import("@mantine/core/lib/core").MantineComponent<{
    props: TableThProps;
    ref: HTMLTableCellElement;
    stylesNames: 'th';
    compound: true;
}>;
export declare const TableTd: import("@mantine/core/lib/core").MantineComponent<{
    props: TableTdProps;
    ref: HTMLTableCellElement;
    stylesNames: 'td';
    compound: true;
}>;
export declare const TableTr: import("@mantine/core/lib/core").MantineComponent<{
    props: TableTrProps;
    ref: HTMLTableRowElement;
    stylesNames: 'tr';
    compound: true;
}>;
export declare const TableThead: import("@mantine/core/lib/core").MantineComponent<{
    props: TableTheadProps;
    ref: HTMLTableSectionElement;
    stylesNames: 'thead';
    compound: true;
}>;
export declare const TableTbody: import("@mantine/core/lib/core").MantineComponent<{
    props: TableTbodyProps;
    ref: HTMLTableSectionElement;
    stylesNames: 'tbody';
    compound: true;
}>;
export declare const TableTfoot: import("@mantine/core/lib/core").MantineComponent<{
    props: TableTfootProps;
    ref: HTMLTableSectionElement;
    stylesNames: 'tfoot';
    compound: true;
}>;
export declare const TableCaption: import("@mantine/core/lib/core").MantineComponent<{
    props: TableCaptionProps;
    ref: HTMLTableCaptionElement;
    stylesNames: 'caption';
    compound: true;
