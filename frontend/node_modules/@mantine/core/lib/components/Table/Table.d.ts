import { BoxProps, ElementProps, Factory, MantineColor, MantineSpacing, StylesApiProps } from '@mantine/core/lib/core';
import { TableCaption, TableTbody, TableTd, TableTfoot, TableTh, TableThead, TableTr } from '@mantine/core/lib/components/Table/Table.components';
import { TableDataRenderer } from '@mantine/core/lib/components/Table/TableDataRenderer';
import { TableScrollContainer } from '@mantine/core/lib/components/Table/TableScrollContainer';
...
export declare const Table: import("@mantine/core/lib/core").MantineComponent<{
    props: TableProps;
    ref: HTMLTableElement;
    stylesNames: TableStylesNames;
    vars: TableCssVariables;
