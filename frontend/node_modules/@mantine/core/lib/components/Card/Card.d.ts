import { BoxProps, MantineRadius, MantineShadow, MantineSpacing, PolymorphicFactory, StylesApiProps } from '@mantine/core/lib/core';
import { CardSection } from '@mantine/core/lib/components/Card/CardSection/CardSection';
...
export declare const Card: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, CardProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(CardProps & {
    component?: any;
