import { Factory, MantineRadius, MantineShadow, StylesApiProps } from '@mantine/core/lib/core';
import { ArrowPosition, FloatingAxesOffsets, FloatingPosition, FloatingStrategy } from '@mantine/core/lib/components/Floating';
import { PortalProps } from '@mantine/core/lib/components/Portal';
import { TransitionOverride } from '@mantine/core/lib/components/Transition';
import { PopoverMiddlewares, PopoverWidth } from '@mantine/core/lib/components/Popover/Popover.types';
...
export declare namespace Popover {
    var Target: import("@mantine/core/lib/core").MantineComponent<{
        props: import("@mantine/core/lib/components/Popover/PopoverTarget/PopoverTarget").PopoverTargetProps;
        ref: HTMLElement;
        compound: true;
    }>;
    var Dropdown: import("@mantine/core/lib/core").MantineComponent<{
        props: import("@mantine/core/lib/components/Popover/PopoverDropdown/PopoverDropdown").PopoverDropdownProps;
        ref: HTMLDivElement;
        stylesNames: PopoverStylesNames;
        compound: true;
    }>;
