...
import { __InputStylesNames } from '@mantine/core/lib/components/Input';
import { TextareaProps } from '@mantine/core/lib/components/Textarea';
...
export declare const JsonInput: import("@mantine/core/lib/core").MantineComponent<{
    props: JsonInputProps;
    ref: HTMLTextAreaElement;
    stylesNames: __InputStylesNames;
}>;
