import { BoxProps, ElementProps, Factory, MantineColor, MantineRadius, MantineSize, MantineSpacing, StylesApiProps } from '@mantine/core/lib/core';
import { StepperCompleted } from '@mantine/core/lib/components/Stepper/StepperCompleted/StepperCompleted';
import { StepperStep } from '@mantine/core/lib/components/Stepper/StepperStep/StepperStep';
...
export declare const Stepper: import("@mantine/core/lib/core").MantineComponent<{
    props: StepperProps;
    ref: HTMLDivElement;
    stylesNames: StepperStylesNames;
    vars: StepperCssVariables;
