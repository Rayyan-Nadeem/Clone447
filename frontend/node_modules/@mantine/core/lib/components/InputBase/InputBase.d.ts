import { BoxProps, PolymorphicFactory, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const InputBase: (<C = "input">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, InputBaseProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(InputBaseProps & {
    component?: any;
