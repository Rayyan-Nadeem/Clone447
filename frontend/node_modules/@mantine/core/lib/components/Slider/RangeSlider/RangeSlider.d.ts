...
import { SliderCssVariables, SliderStylesNames } from '@mantine/core/lib/components/Slider/Slider.context';
...
export declare const RangeSlider: import("@mantine/core/lib/core").MantineComponent<{
    props: RangeSliderProps;
    ref: HTMLDivElement;
    stylesNames: SliderStylesNames;
    vars: SliderCssVariables;
