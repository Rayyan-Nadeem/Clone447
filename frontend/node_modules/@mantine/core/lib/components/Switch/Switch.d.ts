...
import { SwitchGroup } from '@mantine/core/lib/components/Switch/SwitchGroup/SwitchGroup';
...
export declare const Switch: import("@mantine/core/lib/core").MantineComponent<{
    props: SwitchProps;
    ref: HTMLInputElement;
    stylesNames: SwitchStylesNames;
    vars: SwitchCssVariables;
