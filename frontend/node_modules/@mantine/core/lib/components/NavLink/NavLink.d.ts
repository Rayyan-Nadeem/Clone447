import { BoxProps, MantineColor, MantineSize, PolymorphicFactory, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const NavLink: (<C = "a">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, NavLinkProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(NavLinkProps & {
    component?: any;
