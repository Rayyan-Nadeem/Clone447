import { BoxProps, MantineRadius, MantineShadow, PolymorphicFactory, StylesApiProps } from '@mantine/core/lib/core';
...
export declare const Paper: (<C = "div">(props: import("@mantine/core/lib/core").PolymorphicComponentProps<C, PaperProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(PaperProps & {
    component?: any;
