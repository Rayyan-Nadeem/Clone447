...
import type { CssVarsProp, MantineStyleProp } from '@mantine/core/lib/core/Box/Box.types';
import { MantineStyleProps } from '@mantine/core/lib/core/Box/style-props';
...
export declare const Box: (<C = "div">(props: import("@mantine/core/lib/core/factory").PolymorphicComponentProps<C, BoxComponentProps>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>) & Omit<import("react").FunctionComponent<(BoxComponentProps & {
    component?: any;
